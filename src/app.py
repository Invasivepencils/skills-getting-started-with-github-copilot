...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn tennis skills, sportsmanship, and match play",
    ...
    "Art Studio": {
        ...
        "max_participants": 14,
        "participants": ["emma@mergington.edu", "zoe@mergington.edu"]
    },
    "Drama Club": {
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if not activity_name or not email:
        raise HTTPException(status_code=400, detail="Activity name and email are required")
